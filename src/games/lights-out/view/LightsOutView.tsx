...
import { type LightsOutMove, type LightsOutState } from '../engine/types';

import s from './LightsOutView.module.css';

export function LightsOutView({
  state,
  dispatch,
  interactive,
  hint,
}: GameViewProps<LightsOutState, LightsOutMove>) {
