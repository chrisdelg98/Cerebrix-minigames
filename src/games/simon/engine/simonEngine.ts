...
import { type SimonConfig, type SimonMove, type SimonState } from './types';
...
export const simonEngine: GameEngine<SimonState, SimonMove, SimonConfig> = {
  ...
  deserialize(raw) {
    return JSON.parse(raw) as SimonState;
  },
};
